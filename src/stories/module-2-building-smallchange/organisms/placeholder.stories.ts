...
export default {
  ...
  title: "Module 2: Building SmallChange/Organisms/Placeholder",
  ...
  decorators: [
    ...
    moduleMetadata({
      ...
      declarations: [
        // Organisms often need to know about other atoms and molecules, so add the components this one should know about here:
