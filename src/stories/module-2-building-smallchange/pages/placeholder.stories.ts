...
export default {
  ...
  title: "Module 2: Building SmallChange/Pages/Placeholder",
  ...
  decorators: [
    ...
    moduleMetadata({
      ...
      declarations: [
        // Pages often need to know about other atoms, molecules, and organisms, so add the components this one should know about here:
