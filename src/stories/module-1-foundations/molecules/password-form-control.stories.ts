...
export default {
  title: 'Module 1: Foundations/Section 2: Molecules/Password Form Control',
  component: PasswordFormControlComponent,
  decorators: [
...
const Template: Story<PasswordFormControlComponent> = (args: PasswordFormControlComponent) => ({
  props: args,
});
